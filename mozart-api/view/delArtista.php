...
//Select
    ...
    $sql= "SELECT A.idUsuario, A.nome, A.sobrenome, A.contato, A.email, A.senha, A.dataNascimento,A.foto, B.idSeguimento, B.nomeSeguimento, C.idArtista, C.descricao FROM dbmozarte.usuario A,seguimento B, artista C WHERE idUsuario = 9";
...
<html>
    ...
    <body>
        <form  action="../model/updateArtista.php" method="post" >
                    ...
                    <button type="submit" name="btn-deletar" class="btn green">Deletar</button>        
            </form>
